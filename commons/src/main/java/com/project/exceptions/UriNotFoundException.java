...
public class UriNotFoundException extends RuntimeException implements GenericException {
	...
	public UriNotFoundException(String errorMessage, String correlationId) {
		super(errorMessage);
		this.errorCode = Constants.URI_NOT_FOUND_CODE;
		this.errorMessage = errorMessage;
		this.errorType = Constants.URI_NOT_FOUND_TYPE;
